...
if s:configuration.enable_italic
  ...
  call gruvbox_material#highlight('Repeat', s:palette.green, s:palette.none, 'italic')
  call gruvbox_material#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call gruvbox_material#highlight('Typedef', s:palette.green, s:palette.none, 'italic')
  ...
  call gruvbox_material#highlight('Keyword', s:palette.green, s:palette.none)
  call gruvbox_material#highlight('Typedef', s:palette.green, s:palette.none)
  call gruvbox_material#highlight('Exception', s:palette.red, s:palette.none)
  call gruvbox_material#highlight('Statement', s:palette.aqua, s:palette.none)
endif
...
call gruvbox_material#highlight('Structure', s:palette.green, s:palette.none)
call gruvbox_material#highlight('Operator', s:palette.green, s:palette.none)
call gruvbox_material#highlight('Title', s:palette.green, s:palette.none, 'bold')
