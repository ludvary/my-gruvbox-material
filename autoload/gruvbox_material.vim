...
function! gruvbox_material#get_configuration() "{{{
  return {
        ...
        \ 'enable_bold': get(g:, 'gruvbox_material_enable_bold', 1),
        \ 'enable_italic': get(g:, 'gruvbox_material_enable_italic', 1),
        ...
        \ 'ui_contrast': get(g:, 'gruvbox_material_ui_contrast', 'high'),
  ...
  if a:background ==# 'hard' "{{{
    if &background ==# 'dark'
      let palette1 = {
            ...
            \ 'bg4':              ['#040404',   '237'],
            \ 'bg5':              ['#040404',   '239'],
            \ 'bg_statusline1':   ['#2E342A',   '235'],
            \ 'bg_statusline2':   ['#040404',   '235'],
